...
abstract class $PokemonCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? id, String? name, String? classification, String? image});
}
...
class _$_Pokemon implements _Pokemon {
  _$_Pokemon(this.id, this.name, this.classification, this.image);
  ...
  @override
  String toString() {
    return 'Pokemon(id: $id, name: $name, classification: $classification, image: $image)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, classification, image);
...
abstract class _Pokemon implements Pokemon {
  factory _Pokemon(final String? id, final String? name,
      final String? classification, final String? image) = _$_Pokemon;
